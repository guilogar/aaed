...
int main(int argc, const char *argv[])
{
    ...
    //EJ 1: Numero discreto aleatorio entre a y b.
    cout << "EJ 1: El número aleatorio discreto es => " << num_aleat_int(a, b) << "." << endl;
    ...
    //EJ 3: Numero continuo aleatorio entre a y b.
    cout << "EJ 3: El número aleatorio continuo es => " << num_aleat_double(a, b) << "." << endl;
    
    //EJ 4: Numero aleatorio muy grande.
    double res = num_aleat_muy_grande(10000000L);
    std::cout << "EJ 4: Y la media de tantos numeros es => " << res << std::endl;
    
    //EJ 5: Permutaciones numeros.
    double resu = perm_pseudo_aleat(6, 10000000L);
    std::cout << "EJ 5: Existen " << resu << " de permutaciones ordenadas." << std::endl;
    return 0;
}
